...
export class createLoanAndInstallmentTables1662689716983 implements MigrationInterface {
    name = 'createLoanAndInstallmentTables1662689716983'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "loans" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "cpf" character varying NOT NULL, "uf" character varying NOT NULL, "birthdate" TIMESTAMP NOT NULL, "total" integer NOT NULL, "valueByMonth" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_5c6942c1e13e4de135c5203ee61" PRIMARY KEY ("id"))`);
